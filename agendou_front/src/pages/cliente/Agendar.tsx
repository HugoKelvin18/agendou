        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
                <div className="text-center">
                    ...
                    <p className="text-base md:text-lg text-gray-700">Carregando profissionais e serviços...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-xl shadow-xl p-6 md:p-8">
                    <div className="flex items-center gap-4 mb-2">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Agendar Serviço</h1>
                            <p className="text-sm md:text-base text-gray-600 mb-6">Preencha os dados para agendar seu atendimento</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                            <label className="flex items-center gap-2 text-xs md:text-sm font-semibold text-blue-900 mb-2">
                                <User size={18} />
                                Profissional
                            </label>
                            <Select
                        ...
                        {form.profissionalId && (
                            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                                <label className="flex items-center gap-2 text-xs md:text-sm font-semibold text-green-900 mb-2">
                                    <CheckCircle size={18} />
                                    Serviço
                                </label>
                                            ...
                                            <div className="mt-4 p-4 bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg border-2 border-green-200 shadow-sm">
                                                <div className="space-y-3">
                                                    {servicoSelecionado.descricao && (
                                                        <div>
                                                            <h4 className="text-xs md:text-sm font-semibold text-green-900 mb-2 flex items-center gap-2">
                                                                <CheckCircle size={16} className="text-green-600" />
                                                                Sobre este serviço
                                                            </h4>
                                                            <p className="text-xs md:text-sm text-gray-700 leading-relaxed bg-white p-3 rounded border border-green-100">
                                                                {servicoSelecionado.descricao}
                                                            </p>
                                                        </div>
                                                    )}
                        ...
                        {form.profissionalId && form.servicoId && (
                            <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                                <label className="flex items-center gap-2 text-xs md:text-sm font-semibold text-purple-900 mb-3">
                                    <Calendar size={18} />
                                ...
                                {loadingDisponibilidades ? (
                                    <div className="text-center py-4">
                                        ...
                                        <p className="text-xs md:text-sm text-gray-600">Carregando dias disponíveis...</p>
                                    </div>
                                            ...
                                            {datasDisponiveis.map((dataISO) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`px-3 py-2 md:px-4 md:py-3 rounded-lg border-2 transition-all text-left ${
                                                            dataSelecionada
                        ...
                        {form.data && form.profissionalId && form.servicoId && (
                            <div className="bg-orange-50 rounded-lg p-4 border border-orange-200">
                                <label className="flex items-center gap-2 text-xs md:text-sm font-semibold text-orange-900 mb-3">
                                    <Clock size={18} />
                                                ...
                                                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3">
                                                    {horariosDisponiveis.map((hora) => (
                                                        <button
                                                            ...
                                                            className={`px-3 py-1.5 md:px-4 md:py-2 rounded-lg border-2 transition-all font-medium text-xs md:text-sm ${
                                                                form.hora === hora
                        ...
                        <div className="flex gap-4 justify-end pt-4 border-t">
                            <button
                                type="button"
                                onClick={() => navigate("/cliente/dashboard")}
                                className="px-4 py-2 md:px-6 md:py-3 border-2 border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 text-xs md:text-sm font-medium transition-colors"
                            >
                                Cancelar
                            </button>
                            <button
                                ...
                                className="px-4 py-2 md:px-6 md:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-xs md:text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
                            >
